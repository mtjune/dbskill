...
<table>
<tr>
	<td>ユーザID</td><td><input type="text" name="user_id" maxlength="16"></td>
</tr>
<tr>
	<td>パスワード</td><td><input type="password" name="user_pass" maxlength="16"></td>
</tr>
<tr>
	<td>ユーザ名</td><td><input type="text" name="user_name" maxlength="16"></td>
</tr>
</table>
