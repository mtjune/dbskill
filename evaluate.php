...
$pic_id = $_POST['pic_id'];
$eva_value = $_POST['eva_value'];

if($is_login){
    $sql = "select * from evaluations where pic_id = '$pic_id' and user_id = '$login_user_id'";
    $res = mysql_query($sql, $conn);
    if(mysql_num_rows($res) === 0){
        $sql = "insert into evaluations values('$pic_id', '$login_user_id', ".$eva_value.")";
